...
import { LayoutDashboard, Plus, Folder, Settings } from "lucide-react";
    ...
    >
      <div className="flex items-stretch max-w-lg mx-auto">
        {NAV_ITEMS.map(({ href, label, icon: Icon }) => {
          // Mark Add as active for both /expenses/add and /expenses/new
          const isActive =
            href === "/expenses/add"
              ? pathname.startsWith("/expenses/add") ||
